    ...
    <nav class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-gray-800 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
      <div class="flex flex-wrap justify-between items-center">
        <div class="flex justify-start items-center">
          ...
          <a href="https://lichter.io" class="flex items-center justify-between mr-4">
            <img
              src="https://www.lichter.io/img/logo/glyph-white-colored.svg"
              class="mr-3 h-8"
              alt="Logo"
            />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Alex's Demo App</span>
          </a>
              ...
              >
                <div class="flex-shrink-0">
                  <img
                    class="w-11 h-11 rounded-full"
                    src="https://lichter.io/img/me@2x.webp"
                    alt="Jese Alexander Lichter avatar"
                  />
                  <div
              ...
              >
                <div class="flex-shrink-0">
                  <img
                    class="w-11 h-11 rounded-full"
                    src="https://lichter.io/img/me@2x.webp"
                    alt="Joseph Alexander Lichter avatar"
                  />
                  <div
              ...
              >
                <div class="flex-shrink-0">
                  <img
                    class="w-11 h-11 rounded-full"
                    src="https://lichter.io/img/me@2x.webp"
                    alt="Roberta Alexander Lichter image"
                  />
                  <div
